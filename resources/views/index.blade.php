        ...
        <div class="container">
            ...
            <div class="row gx-5">
                ...
                <div class="col-lg-6 pb-5">
                    <h4 class="mb-4">Delicious Bakery là thương hiệu bánh ngọt Pháp của công ty cổ phần bánh ngọt Delicious. Được thành lập từ năm 2021 tại con phố nhỏ ở Thủ Đức, Việt Nam. Các sản phẩm Delicious Bakery được làm từ các nguyên liệu nhập khẩu của các nước có truyền thống làm bánh như: Newzeland, Mỹ, Pháp, Bỉ. Với hương vị thơm ngon đặc trưng của các loại kem, bơ, sữa, phô mai, hạt hạnh nhân, chocolate... dưới bàn tay khéo léo của những người thợ làm bánh giàu kinh nghiệm.</h4>
                    <p class="mb-5"> Delicious Bakery luôn mang đến cho khách hàng những sản phẩm chất lượng nhất, đảm bảo tuyệt đối về an toàn vệ sinh thực phẩm.</p>
                    <div class="row g-5">
                        <div class="col-sm-6">
                            ...
                            <p class="mb-0">Với nguyên liệu được chọn lọc kĩ càng trong từng khâu, chúng tôi đặt sức khỏe của người tiêu dùng lên hàng đầu</p>
                        </div>
                        <div class="col-sm-6">
                            <div class="d-flex align-items-center justify-content-center bg-primary border-inner mb-4" style="width: 90px; height: 90px;">
                            ...
                            <p class="mb-0">Các sản phẩm được 100.000 người trên thế giới tin dùng</p>
                        </div>
                    </div>
                </div>
            </div>
