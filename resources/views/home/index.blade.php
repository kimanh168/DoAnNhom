            ...
            <div class="row g-5">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="bg-primary border-inner text-center text-white p-5">
                        ...
                        <p>It is usually coated and decorated with frosting. The layers may be filled with pastry cream. It may be topped by decorations made from frosting, with edible flowers, or with other decorations</p>
                        <a class="text-uppercase text-dark" href="">Read More <i class="bi bi-arrow-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6">
        ...
        <div class="container py-5">
            <div class="row gx-5 justify-content-center">
                <div class="col-lg-7 text-center">
                    ...
                    <a href="{{ route('menu', ['cate'=> 5]) }}" class="btn btn-primary border-inner py-3 px-5 me-3">Shop Now</a>
                </div>
            </div>
        </div>
    </div>
